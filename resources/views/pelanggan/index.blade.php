    ...
    <div class="card m-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-start mb-5">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalFormpelanggan"> Tambah
                    Pelanggan </button>
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalImportData">
                    Import Data
                </button>

                <a href="{{ route('export-pelanggan') }}" class="btn btn-success">Export Excel</a>

                <a href="{{ route('export-pelanggan-pdf') }}" class="btn btn-danger">Export pdf</a>
